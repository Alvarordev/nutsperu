...
const features = [
    {
        ...
        description:
            "Por más de 16 años, hemos sido líderes en la distribución de frutos secos y snacks saludables en Lima. Nuestra experiencia nos permite entender las necesidades de nuestros clientes y ofrecer soluciones personalizadas.",
